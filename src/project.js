...
export class Info {
  practices(practice) {
    return new Promise(function(resolve, reject) {
      ...
      const url =`https://api.betterdoctor.com/2016-03-01/doctors?&specialty_uid=${practice}&location=45.5051%2C-122.6750%2C100&user_location=37.773%2C-122.413&skip=0&limit=30&user_key=${process.env.exports.apiKey}`
